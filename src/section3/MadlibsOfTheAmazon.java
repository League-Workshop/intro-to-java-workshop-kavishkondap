...
String place =JOptionPane.showInputDialog(null,"Enter a place");
		...
		String Madlib = "Piranhas are more " + adjective +" during the day, so cross the river \n"
+ " at night. Prianhas are attracted to fresh " + liquid + " and will most likely take a bite out \n"
+ "of your " + body + " if you " + verb + " . Whatever you do, if you have an open wound, try to find \n"
+ "another way to get back to the " + place + " . Good Luck!";
